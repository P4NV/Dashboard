    ...
    return (
        ...
        >
            ...
            <div className={`w-full flex justify-center items-center
                            ${isOpen && 'gap-4'}`}>
                <img src={user} alt="user" className="min-w-10 h-10 transition-all duration-300 "/>
                <h1 className={`text-2xl font-bold whitespace-nowrap transition-all duration-300 ${
                    isOpen ? 'opacity-100 translate-x-0 delay-400' : 'opacity-0 -translate-x-4 w-0'
                }`}>
                    Name
                </h1>
            </div>
            ...
            <div className="flex flex-col w-full gap-4">
                ...
                <button className="flex items-center gap-3 hover:bg-[#d4cab0] p-2 rounded-lg transition-all">
                    ...
                    <span className={`whitespace-nowrap transition-all duration-500 ${
                        isOpen ? 'opacity-100 translate-x-0 delay-200' : 'opacity-0 -translate-x-4 w-0'
                    }`}>
                        Search
                    </span>
                </button>
            ...
            <hr className={`border-2 rounded-full transition-all duration-500 ${
                isOpen ? 'w-4/5 opacity-100 delay-200' : 'w-0 opacity-0'
            }`}/>
            ...
            <div className={`flex flex-col w-full items-center transition-all duration-300 ${
                isOpen ? 'opacity-100 max-h-40 delay-200' : 'opacity-0 max-h-0'
            }`}>
                <h1 className="text-sm font-semibold mb-1">Social support</h1>
                <hr className="mb-2 w-4/5 border-2 rounded-full"/>
